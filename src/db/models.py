...
class DiagnosticModel(Base):
    ...
    docker_image_path: Mapped[str | None] = mapped_column(String, nullable=True) # e.g. "clinisandbox/sepsis:v1"
    model_weights_path: Mapped[str | None] = mapped_column(String, nullable=True) # e.g. "s3://models/sepsis.pt"
